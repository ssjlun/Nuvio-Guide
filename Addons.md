...
4. Then go down to where you see import and use my file to import my settings/filters. Click on Import Config.
...
3. Then go down to where you see import configuration and use my file to import my settings.
